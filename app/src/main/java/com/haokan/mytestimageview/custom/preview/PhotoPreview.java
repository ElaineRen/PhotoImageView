...
public class PhotoPreview {
     ...
     * 设置图片长按监听
     */
    public void setLongClickListener(OnGestureListener.OnLongClickListener listener) {
    ...
    public static class Builder {
         ...
         * 设置预览界面长按点检监听
         */
        public Builder onLongClickListener(OnGestureListener.OnLongClickListener listener) {
            mConfig.onLongClickListener = listener;
            return this;
        }
        /**
         * 设置pager内部图片点击下标回调监听
         */
        public Builder onPagerItemClickListener(OnPagerItemPositionListener listener){
            mConfig.mOnPagerItemPositionListener=listener;
            return this;
        }
        /**
         * 设置预览关闭监听
         ...
         * @return
         */
        public Builder flowPosition(int position){
            mConfig.mFlowPosition=position;
            return this;
        }
